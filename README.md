...
It should be pointed out that this essay only analyzes the positive and negative parts. This project is a kind of modified direction of the essay, when enough data is collected, greater accuracy can be obtained.
